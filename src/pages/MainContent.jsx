...
const MainContent = ({ handleClick, selectedSubmenu }) => {
  return (
    <div className="flex flex-col w-screen h-screen p-4" style={{ marginLeft: "192px", marginRight: "192px" }}>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        ...
        {selectedSubmenu === "Programme TRP" && (
          <div className="bg-white shadow-lg rounded-md p-6 dark:bg-gray-800 dark:text-gray-100 flex-1 overflow-hidden">
            <ProgrammeTRP /> {/* Render the Programme TRP component */}
          </div>
          
        )}
        {selectedSubmenu === "Strategic Forecasting" && (
          <div className="bg-white shadow-lg rounded-md p-6 dark:bg-gray-800 dark:text-gray-100 flex-1 overflow-hidden">
            <StrategicForecasting /> {/* Render the Strategic Forecasting component */}
          </div>
        )}
        {/* Add other submenu content here as needed */}
      </div>
